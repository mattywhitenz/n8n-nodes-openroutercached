				...
				options: [
					{
						...
						values: [
							...
							},
							{
								...
								type: 'boolean',
								default: false,
								description: 'Only route to providers that support all specified parameters',
							},
							{
								...
								type: 'boolean',
								default: false,
								description: 'Only route to providers with Zero Data Retention policies (GDPR/HIPAA compliance)',
							},
							{
